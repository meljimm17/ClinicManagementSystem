...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .act-btn:hover.edit   { background: var(--accent-soft); border-color: #c0dfd0; color: var(--primary); }
        .act-btn:hover.done   { background: #eafaf3; border-color: #a3d9bc; color: #1a7a4e; }
        .act-btn:hover.remove { background: #fff0f0; border-color: #f5b8b8; color: #c0392b; }
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('staff.queue') }}" class="sidebar-link active">
                ...
                <tbody id="queueBody">
                    ...
                    <tr data-status="diagnosing">
                        ...
                        <td style="text-align:right;">
                            <button class="act-btn edit" title="Edit" onclick="openEditModal({
                                id: 'Q-001', name: 'Elena Rodriguez',
                                status: 'diagnosing', room: 'Room 02'
                            })"><i class="bi bi-pencil"></i></button>
                            <button class="act-btn done" title="Mark Done"><i class="bi bi-check-lg"></i></button>
                        </td>
                    </tr>
                    ...
                    <tr data-status="waiting">
                        ...
                        <td style="text-align:right;">
                            <button class="act-btn edit" title="Edit" onclick="openEditModal({
                                id: 'Q-002', name: 'Marcus Chen',
                                status: 'waiting', room: ''
                            })"><i class="bi bi-pencil"></i></button>
                            <button class="act-btn remove" title="Remove"><i class="bi bi-trash"></i></button>
                        </td>
                    </tr>
                    ...
                    <tr data-status="waiting">
                        ...
                        <td style="text-align:right;">
                            <button class="act-btn edit" title="Edit" onclick="openEditModal({
                                id: 'Q-004', name: 'James Villanueva',
                                status: 'waiting', room: ''
                            })"><i class="bi bi-pencil"></i></button>
                            <button class="act-btn remove" title="Remove"><i class="bi bi-trash"></i></button>
                        </td>
...
<div class="modal fade" id="editModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="bi bi-pencil-square me-2" style="color:var(--primary);"></i>Edit Queue Entry</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <p style="font-size:.78rem; color:var(--text-muted); margin-bottom:18px;">
                    Editing: <strong id="editPatientName">—</strong> &nbsp;(<span id="editQueueId">—</span>)
                </p>
                <div class="mb-3">
                ...
                <div class="mb-1">
                    <label class="form-label-custom">Staff Notes (optional)</label>
                    <textarea class="form-control-custom" rows="3" placeholder="Add any notes for this queue entry…"></textarea>
                </div>
            </div>
            <div class="modal-footer">
...
<script>
    ...
    function openEditModal(p) {
        document.getElementById('editPatientName').textContent = p.name;
        document.getElementById('editQueueId').textContent = p.id;
