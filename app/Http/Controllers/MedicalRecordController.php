    ...
    public function index()
    {
        ...
        $mappedRecords = $records->map(function ($r) {
            ...
            return [
                ...
                'age'          => $r->patient_age ?? $patient?->age,
                'gender'       => $r->patient_gender ?? $patient?->gender,
                'civil_status' => $r->patient_civil_status ?? $patient?->civil_status,
                'contact'      => $r->patient_contact ?? $patient?->contact_number,
                'address'      => $r->patient_address ?? $patient?->address,
                'blood_type'   => $r->patient_blood_type ?? $patient?->blood_type,
                'height'       => $r->patient_height ?? $patient?->height,
                'weight'       => $r->patient_weight ?? $patient?->weight,
                'philhealth'   => $r->patient_philhealth ?? $patient?->philhealth_no,
                'hmo'          => $r->patient_hmo ?? $patient?->hmo_insurance,
                'emg_name'     => $r->patient_emergency_name ?? $patient?->emergency_contact_name,
                'emg_contact'  => $r->patient_emergency_contact ?? $patient?->emergency_contact_number,
                'allergies'    => $r->patient_allergies ?? $patient?->known_allergies,
                'conditions'   => $r->patient_conditions ?? $patient?->existing_conditions,
                'medications'  => $r->patient_medications ?? $patient?->current_medications,
                'symptoms'     => $r->symptoms,
